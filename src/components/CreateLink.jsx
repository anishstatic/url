...
const CreateLink = () => {
  ...
  <DialogContent className=" sm:max-w-md">
    ...
    <div className=' flex items-center gap-2'>
     ...
     <Input id="customUrl" placeholder="Custom link's (optional)" value={formValues.customUrl} onChange={handleChange} />
     </div>
    {error &&<Error message={errors.message} />}
     <DialogFooter className=' sm:justify-start'>
            <Button disabled={loading} onClick={createNewLink} variant="destructive">{loading ? <BeatLoader size={10} color="white" /> : "Create"} </Button>
          </DialogFooter>
  </DialogContent>
</Dialog>
