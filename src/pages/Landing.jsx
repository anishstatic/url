...
const LandingPage = () => {
  ...
  return  (
    <div className=' flex flex-col items-center'>
      ...
      <form onSubmit={handleShorten} className=' sm:h-14 flex flex-col sm:flex-row w-full md:w-2/4 gap-2'>
        <Input type="url" value={longUrl} placeholder="Enter your long URL...."
          onChange={(e)=> setLongUrl(e.target.value)} 
         className=" h-full flex-1 py-4 px-4" />
        <Button className=" h-full" type="submit" variant="destructive">Shorten!</Button>
      </form>
      <img src="/url banner.png" alt="URL-BANNER" className=' w-full my-11 md:px-11' />
 ...
 <Accordion type="multiple" collapsible className=' w-full md:px-11'>
  <AccordionItem value="item-3">
    ...
    <AccordionContent>
      You can view the number of clicks, goelocation data of the clicks and device (mobile/desktop) for each of your shortened URLs.
    </AccordionContent>
  </AccordionItem>
</Accordion>
